...
I got the offer letter from codecademy, but don't know how it goes with all those visa stuff...

## 2021-04-28
Today's goals 
- [X] Finish the `display_instances` pull request
- [X] Visualize time-series linking results of sorghum data
- [X] 👩‍💻 Leetcode problems: [637](https://leetcode.com/problems/average-of-levels-in-binary-tree/),
